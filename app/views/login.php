...
<body style="background-image: url(https://i.pinimg.com/564x/2b/91/9b/2b919b763efa06dbbda658159ee219af.jpg); background-repeat: no-repeat; background-size: cover;" class="hold-transition login-page">

<div class="login-box">
  <div class="card">
    <div class="card-body login-card-body bg-white">
      <p class="login-card-msg">Selamat Datang Kembali</p>
